================================================================================
    MICROSOFT 基础类库： EffectEditer 项目概述
===============================================================================

应用程序向导已为您创建了此 EffectEditer 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 EffectEditer 应用程序的每个文件的内容摘要。
...
EffectEditer.h
    ...
    CEffectEditerApp 应用程序类。

EffectEditer.cpp
    这是包含应用程序
    类 CEffectEditerApp 的主应用程序源文件。
...
res\EffectEditer.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 EffectEditer.rc 中。

res\EffectEditer.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 EffectEditer.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

EffectEditerDoc.h、EffectEditerDoc.cpp - 文档
    这些文件包含 CEffectEditerDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CEffectEditerDoc::Serialize）。
EffectEditerView.h、EffectEditerView.cpp - 文档视图
    这些文件包含 CEffectEditerView 类。
    CEffectEditerView 对象用于查看 CEffectEditerDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 EffectEditer.pch 的预编译头文件 (PCH)
